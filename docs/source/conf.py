...
configuration = Configuration(
    {"Plugins": {"SqliteRegistry": {"db_file": ":memory:"}}, "Sites": []}
)
...
latex_documents = [
    (master_doc, "tardis.tex", "tardis Documentation", author, "manual"),
]
...
man_pages = [(master_doc, "tardis", "tardis Documentation", [author], 1)]
